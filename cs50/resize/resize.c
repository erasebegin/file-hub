...
int main(int argc, char *argv[])
{
    ...
    // remember filenames and user-specified enlargement factor
    char *factor_p = argv[1]; //this is the user input accepted as a pointer
    int factor = (int)factor_p; //this converts the pointer to an integer
    char *infile = argv[2];
    char *outfile = argv[3];
